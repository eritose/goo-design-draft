...
@RestController
@RequestMapping("/api/goo-design-draft-kafka")
public class GooDesignDraftKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GooDesignDraftKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GooDesignDraftKafkaResource(KafkaProperties kafkaProperties) {
